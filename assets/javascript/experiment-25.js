...
let strichstaerke_fein = 8;

let noiseOffset = 1; //0.001 -> SCHRIFT DEUTLICHER BEI ZB 0.1
...
//   a.arc(m_5.x, m_5.y, 0.6 * schriftgrad , 0.6 * schriftgrad, -HALF_PI, 0);
  ...
  H.strokeWeight(30);
  H.strokeCap(SQUARE);
  O = createGraphics(O_schriftbild + (8 * O_vnb), schriftgrad * 0.95);

  // Zurichtung testen und allenfalls die Parameter in H_vnb und/oder O_vnb anpassen.
  E = createGraphics(E_schriftbild + H_vnb + H_vnb+O_vnb+O_vnb, schriftgrad * 0.95);

  A = createGraphics(E_schriftbild_4 + (5 * Versal_vbn_minimal)+O_vnb+O_vnb, schriftgrad * 0.95);

  B = createGraphics(E_schriftbild_3 + H_vnb + H_vnb_halbiert+H_vnb+O_vnb, schriftgrad * 0.95); //angepasst
  ...
  K = createGraphics(E_schriftbild_7 + H_vnb + Versal_vbn_minimal+ H_vnb+O_vnb+O_vnb+O_vnb, schriftgrad * 0.95);

  L = createGraphics(E_schriftbild_1 + H_vnb + H_vnb+O_vnb, schriftgrad * 0.95);

  M = createGraphics(E_schriftbild_5 + (2 * H_vnb_vermindert), schriftgrad * 0.95); //angepasst

  N = createGraphics(E_schriftbild_5 + (2 * H_vnb_vermindert)+O_vnb+O_vnb, schriftgrad * 0.95); //angepasst
  ...
  R = createGraphics(E_schriftbild + H_vnb + O_vnb + H_vnb + H_vnb_halbiert+ O_vnb+O_vnb+O_vnb, schriftgrad * 0.95);
  ...
  U = createGraphics(E_schriftbild_7 + H_vnb + H_vnb_halbiert, schriftgrad * 0.95);
  ...
  Z = createGraphics(E_schriftbild_3 +(6 * H_vnb_halbiert), schriftgrad * 0.95);
...
let form_art = TRIANGLE_STRIP;  //TRIANGLE_STRIP -> QUAD_STRIP auch interessant

let schritt = 0.005; //0.02
...
// H.endShape();
 ...
 noiseOffset += 0.2;  // 0.002  Increment noise offset for animation effect -> spannende Zahlen; 500, 0.1, 0.01, 0.02 //50
//////////////////////////////////////////////////////////////////////////////////////////////
...
W.strokeWeight(strichstaerke_fein);
  ...
  for (let t = 0; t <= 1; t += schritt) {
    ...
    let xOffset = map(noise(noiseOffset, t * 5), 0, 1, -30, 60);
    let yOffset = map(noise(noiseOffset + 1000, t * 5), 0, 1, -10, 40);  // Different noise offset for y to make the wiggle more irregular
...
W.strokeWeight(strichstaerke_fein);
  ...
  for (let t = 0; t <= 1; t += schritt) { //0.5
    ...
    let xOffset = map(noise(noiseOffset, t * 5), 0, 1, -30, 40);
    let yOffset = map(noise(noiseOffset + 1000, t * 5), 0, 1, -40, 40);  // Different noise offset for y to make the wiggle more irregular
...
W.strokeWeight(strichstaerke_fein);
  ...
  for (let t = 0; t <= 1; t += schritt) {
    ...
    let xOffset = map(noise(noiseOffset, t * 5), 0, 1, -30, 30);
    let yOffset = map(noise(noiseOffset + 1000, t * 5), 0, 1, -10, 40);  // Different noise offset for y to make the wiggle more irregular
...
// D.rect(0, 0, H_vnb, schriftgrad * 0.95);
U.pop();
let U2_4_x1 = E_schriftbild_7 ;
let U2_4_y1 = H_linie ;
let U2_4_x2 = E_schriftbild_7 ;
...
E.pop();
let E_x1 = H_vnb ;
let E_y1 = H_linie + (strichstaerke/2) ;
let E_x2 =  E_schriftbild + H_vnb;
let E_y2 = H_linie + (strichstaerke/2);
E.push();
...
E.strokeWeight(strichstaerke_fein);
  ...
  for (let t = 0; t <= 1; t += schritt) {
    let x = lerp(E_x1, E_x2, t);
    let y = lerp(E_y1, E_y2, t);
    let xOffset = map(noise(noiseOffset, t * 5), 0, 1, -5, 40);
    let yOffset = map(noise(noiseOffset + 1000, t * 5), 0, 1, -5, 40);  // Different noise offset for y to make the wiggle more irregular
...
E.pop();
let E2_x1 = H_vnb ;
let E2_y1 = versalien_hilfslinie_1 ;
let E2_x2 =  E_schriftbild + H_vnb_halbiert;
let E2_y2 = versalien_hilfslinie_1;
E.push();
E.beginShape(form_art);
E.strokeJoin(BEVEL);
E.strokeCap(PROJECT);
...
E.strokeWeight(strichstaerke_fein);
  ...
  for (let t = 0; t <= 1; t += schritt) {
    let x = lerp(E2_x1, E2_x2, t);
    let y = lerp(E2_y1, E2_y2, t);
    let xOffset = map(noise(noiseOffset, t * 5), 0, 1, -5, 40);
    let yOffset = map(noise(noiseOffset + 1000, t * 5), 0, 1, -5, 40);  // Different noise offset for y to make the wiggle more irregular
...
E.pop();
let E3_x1 = H_vnb ;
let E3_y1 = grundlinie - (strichstaerke/2) ;
let E3_x2 =  E_schriftbild + H_vnb;
let E3_y2 = grundlinie - (strichstaerke/2);
E.push();
E.beginShape(form_art);
E.strokeJoin(BEVEL);
E.strokeCap(PROJECT);
...
E.strokeWeight(strichstaerke_fein);
  ...
  for (let t = 0; t <= 1; t += schritt) {
    let x = lerp(E3_x1, E3_x2, t);
    let y = lerp(E3_y1, E3_y2, t);
    let xOffset = map(noise(noiseOffset, t * 5), 0, 1, -5, 40);
    let yOffset = map(noise(noiseOffset + 1000, t * 5), 0, 1, -5, 40);  // Different noise offset for y to make the wiggle more irregular
...
E.strokeWeight(strichstaerke_fein);
  ...
  for (let t = 0; t <= 1; t += schritt) {
    let x = lerp(E4_x1, E4_x2, t);
    let y = lerp(E4_y1, E4_y2, t);
    let xOffset = map(noise(noiseOffset, t * 5), 0, 1, -5, 40);
    let yOffset = map(noise(noiseOffset + 1000, t * 5), 0, 1, -5, 40);  // Different noise offset for y to make the wiggle more irregular
...
K.strokeWeight(strichstaerke_fein);
  ...
  for (let t = 0; t <= 1; t += schritt) {
    let x = lerp(K_x1, K_x2, t);
    let y = lerp(K_y1, K_y2, t);
    let xOffset = map(noise(noiseOffset, t * 5), 0, 1, -5, 40);
    let yOffset = map(noise(noiseOffset + 1000, t * 5), 0, 1, -5, 40);  // Different noise offset for y to make the wiggle more irregular
...
K.endShape();
K.pop();
let K2_x1 = H_vnb + E_schriftbild_7;
let K2_y1 = H_linie ;
let K2_x2 =  H_vnb;
let K2_y2 = versalien_hilfslinie_1;
K.push();
K.beginShape(form_art);
K.strokeJoin(BEVEL);
K.strokeCap(PROJECT);
...
K.strokeWeight(strichstaerke_fein);
  ...
  for (let t = 0; t <= 1; t += schritt) {
    let x = lerp(K2_x1, K2_x2, t);
    let y = lerp(K2_y1, K2_y2, t);
    let xOffset = map(noise(noiseOffset, t * 5), 0, 1, -5, 40);
    let yOffset = map(noise(noiseOffset + 1000, t * 5), 0, 1, -5, 40);  // Different noise offset for y to make the wiggle more irregular
...
K.pop();
let K3_x1 = H_vnb;
let K3_y1 = versalien_hilfslinie_1 ;
let K3_x2 =  H_vnb + E_schriftbild_7;
let K3_y2 = grundlinie;
K.push();
K.beginShape(form_art);
K.strokeJoin(BEVEL);
K.strokeCap(PROJECT);
...
K.strokeWeight(strichstaerke_fein);
  ...
  for (let t = 0; t <= 1; t += schritt) {
    let x = lerp(K3_x1, K3_x2, t);
    let y = lerp(K3_y1, K3_y2, t);
    let xOffset = map(noise(noiseOffset, t * 5), 0, 1, -5, 40);
    let yOffset = map(noise(noiseOffset + 1000, t * 5), 0, 1, -5, 40);  // Different noise offset for y to make the wiggle more irregular
...
let R2_x2 =  H_vnb + E_schriftbild_7;
...
let R3_x1 = H_vnb ;
let R3_y1 = H_linie;
let R3_x2 =  H_vnb_halbiert + E_schriftbild_7;
...
R.endShape();
R.pop();
let R4_x1 = H_vnb_halbiert + E_schriftbild_7;
...
let Z2_x1 = H_vnb_halbiert;
let Z2_y1 = grundlinie- (strichstaerke/2);
let Z2_x2 = H_vnb_halbiert + E_schriftbild_3;
...
P.strokeWeight(strichstaerke_fein);
  ...
  for (let t = 0; t <= 1; t += schritt) {
    let x = lerp(P_x1, P_x2, t);
    let y = lerp(P_y1, P_y2, t);
    let xOffset = map(noise(noiseOffset, t * 5), 0, 1, -5, 40);
    let yOffset = map(noise(noiseOffset + 1000, t * 5), 0, 1, -5, 40);  // Different noise offset for y to make the wiggle more irregular
...
let P2_x1 = H_vnb;
let P2_y1 = H_linie;
let P2_x2 = E_schriftbild_7;
let P2_y2 =  H_linie+((versalien_hilfslinie_1-H_linie)/2);
P.push();
P.beginShape(form_art);
P.strokeJoin(BEVEL);
P.strokeCap(ROUND);
...
P.strokeWeight(strichstaerke_fein);
  ...
  for (let t = 0; t <= 1; t += schritt) {
    let x = lerp(P2_x1, P2_x2, t);
    let y = lerp(P2_y1, P2_y2, t);
    let xOffset = map(noise(noiseOffset, t * 5), 0, 1, -5, 40);
    let yOffset = map(noise(noiseOffset + 1000, t * 5), 0, 1, -5, 40);  // Different noise offset for y to make the wiggle more irregular
...
P.endShape();
P.pop();
let P3_x1 = E_schriftbild_7;
let P3_y1 = H_linie+((versalien_hilfslinie_1-H_linie)/2);
let P3_x2 = H_vnb;
let P3_y2 =  versalien_hilfslinie_1;
P.push();
P.beginShape(form_art);
P.strokeJoin(BEVEL);
P.strokeCap(ROUND);
...
P.strokeWeight(strichstaerke_fein);
  ...
  for (let t = 0; t <= 1; t += schritt) {
    let x = lerp(P3_x1, P3_x2, t);
    let y = lerp(P3_y1, P3_y2, t);
    let xOffset = map(noise(noiseOffset, t * 5), 0, 1, -5, 40);
    let yOffset = map(noise(noiseOffset + 1000, t * 5), 0, 1, -5, 40);  // Different noise offset for y to make the wiggle more irregular
...
// N
let N_x1 = H_vnb_vermindert;
let N_y1 = grundlinie;
let N_x2 = H_vnb_vermindert;
let N_y2 = H_linie;
N.push();
...
N.endShape();
N.pop();
let N2_x1 = H_vnb_vermindert;
let N2_y1 = H_linie;
let N2_x2 = H_vnb_vermindert +E_schriftbild_7;
...
N.endShape();
N.pop();
let N3_x1 = H_vnb_vermindert+E_schriftbild_7;
let N3_y1 = grundlinie;
let N3_x2 = H_vnb_vermindert +E_schriftbild_7;
let N3_y2 = H_linie;
N.push();
N.beginShape(form_art);
N.strokeJoin(BEVEL);
...
// A
let A_x1 = Versal_vbn_minimal;
let A_y1 = grundlinie;
let A_x2 = Versal_vbn_minimal+(E_schriftbild_4/2);
let A_y2 = H_linie;
A.push();
...
A.endShape();
A.pop();
let A2_x1 = Versal_vbn_minimal+(E_schriftbild_4/2);
let A2_y1 = H_linie;
let A2_x2 = Versal_vbn_minimal+E_schriftbild_4;
...
let A3_x1 = Versal_vbn_minimal* 10;
let A3_y1 = versalien_hilfslinie_1;
let A3_x2 = (Versal_vbn_minimal+E_schriftbild_4)-(Versal_vbn_minimal*10);
...
B.pop();
let B2_x1 = H_vnb;
let B2_y1 = grundlinie;
let B2_x2 = H_vnb + E_schriftbild_3;
let B2_y2 = grundlinie;
B.push();
B.beginShape(form_art);
B.strokeJoin(BEVEL);
B.strokeCap(ROUND);
...
B.endShape();
B.pop();
let B3_x1 = H_vnb + E_schriftbild_3;
let B3_y1 = grundlinie;
let B3_x2 = H_vnb;
...
B.pop();
let B4_x1 = H_vnb;
let B4_y1 = versalien_hilfslinie_1;
let B4_x2 = H_vnb + E_schriftbild_3;
let B4_y2 = versalien_hilfslinie_1;
B.push();
B.beginShape(form_art);
B.strokeJoin(BEVEL);
B.strokeCap(ROUND);
...
B.endShape();
B.pop();
let B5_x1 = H_vnb+E_schriftbild_3;
let B5_y1 = versalien_hilfslinie_1;
let B5_x2 = H_vnb ;
let B5_y2 = H_linie;
B.push();
B.beginShape(form_art);
