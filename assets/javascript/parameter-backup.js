...
let form_art = TRIANGLE_FAN;
let schritt = 0.008; // 0.2, 0.02, 0.1, 0.003
...
let E_4_x1 = 2*O_vnb + (strichstaerke*2) ;
let E_4_y1 = H_linie +(strichstaerke/2);
let E_4_x2 = 2*O_vnb + (strichstaerke*2);
...
E.endShape();
E.pop();
let E2_4_x1 = 2*O_vnb + (strichstaerke/1.6) ;
...
E.endShape();
E.pop();
let E3_4_x1 = 2*O_vnb+ (strichstaerke/1.6) ;
...
E.endShape();
E.pop();
let E4_4_x1 = 2*O_vnb+ (strichstaerke/1.6) ;
...
// F
let F_4_x1 = 2*O_vnb + (strichstaerke*2);
let F_4_y1 = H_linie ;
let F_4_x2 =2*O_vnb + (strichstaerke*2);
...
F.endShape();
F.pop();
let F2_4_x1 = 2*O_vnb + (strichstaerke*2);
...
F.endShape();
F.pop();
let F3_4_x1 = O_vnb + (strichstaerke/2);
...
// Define the control points for the bezier curve
 let control2X1 = P4_4_x1 + 127;  // Adjust control points as needed
...
let control2Y1 = P4_4_y1 - 40;  // Example control point, adjust as needed
 let control2X2 = P4_4_x2 + 127;  // Adjust control points as needed
...
let S_4_x1 = O_schriftbild-O_vnb ;
let S_4_y1 = H_linie+O_vnb;
let S_4_x2 =(O_schriftbild/2) ;
let S_4_y2 = versalien_hilfslinie_1;

// Define the control points for the bezier curve
 let controlSX1 = S_4_x1 - 80;  // Adjust control points as needed
//let control2X1 = P4_4_x1 + 140;  // Adjust control points as needed
let controlSY1 = S_4_y1 - 60;  // Example control point, adjust as needed
 let controlSX2 =  S_4_x2 - 80;  // Adjust control points as needed
//let control2X2 = P4_4_x2 + 140;  // Adjust control points as needed
let controlSY2 = S_4_y2 +10;  // Example control point, adjust as needed
...
// Define the control points for the bezier curve
 let controlS2X1 = S2_4_x1 + 80;  // Adjust control points as needed
//let control2X1 = P4_4_x1 + 140;  // Adjust control points as needed
let controlS2Y1 = S2_4_y1 + 10;  // Example control point, adjust as needed
 let controlS2X2 =  S2_4_x2 + 80;  // Adjust control points as needed
//let control2X2 = P4_4_x2 + 140;  // Adjust control points as needed
let controlS2Y2 = S2_4_y2 + 90;  // Example control point, adjust as needed
...
// G.endShape();
// G.pop();
let G4_x1 =(O_schriftbild/2)+O_vnb;
let G4_y1 = grundlinie_ueberhang;
let G4_x2 = O_schriftbild-O_vnb;
...
let G_4_x1 = (O_schriftbild/2)+2*O_vnb;
let G_4_y1 = H_linie + (strichstaerke/2);
let G_4_x2 =(O_schriftbild/2)+2*O_vnb;
let G_4_y2 = grundlinie_ueberhang;

// Define the control points for the bezier curve
 let controlGX1 = G_4_x1  - 115;  // Adjust control points as needed
//let control2X1 = P4_4_x1 + 140;  // Adjust control points as needed
let controlGY1 = G_4_y1 - 40;  // Example control point, adjust as needed
 let controlGX2 = G_4_x2 - 100;  // Adjust control points as needed
//let control2X2 = P4_4_x2 + 140;  // Adjust control points as needed
...
let A_x1 = O_vnb/2;
let A_y1 = grundlinie;
let A_x2 = O_vnb/2+(O_schriftbild/2);
let A_y2 = H_linie;
A.push();
A.beginShape(form_art);
A.strokeJoin(BEVEL);
...
A.endShape();
A.pop();
let A2_x1 = O_vnb/2+(O_schriftbild/2);
let A2_y1 = H_linie;
let A2_x2 = O_schriftbild;
...
let A3_x1 = O_schriftbild-(O_vnb/2);
...
N.endShape();
N.pop();
let N3_x1 = O_schriftbild-O_vnb;
let N3_y1 = grundlinie;
let N3_x2 = O_schriftbild-O_vnb;
let N3_y2 = H_linie;
N.push();
N.beginShape(form_art);
N.strokeJoin(BEVEL);
...
// }
// H.endShape();
 noiseOffset += 0.001;  // Increment noise offset for animation effect    // 0.01,1, 0.0005, 5
//////////////////////////////////////////////////////////////////////////////////////////////
