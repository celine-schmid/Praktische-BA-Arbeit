...
let numPoints;
///////
let buchstaben_hintergrund = 200;
...
let O_vnb = O_schriftbild * 0.12; // Faktor muss je nach Schrift angepasst werden.
...
// Zurichtung
let O_vnb = O_schriftbild * 0.12; // Faktor muss je nach Schrift angepasst werden; Die Vor- und Nachbreite des O ist etwas kleiner als jenen des H.
...
// Control points for bezier curve - adjust as needed for desired curvature
let control2X1 = O_vnb * 1.5 + strichstaerke + (O_schriftbild / 1.5) + 30;
