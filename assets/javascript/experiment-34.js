...
let form_art = TRIANGLES;
let schritt = 0.001; // 0.2, 0.02, 0.1, 0.003
...
let P_4_x1 =O_vnb * 3 + (strichstaerke/2) ;
let P_4_y1 = H_linie + strichstaerke/2;
let P_4_x2 = O_vnb * 3 + (strichstaerke/2);
...
let control2Y1 = P4_4_y1 - 40;  // Example control point, adjust as needed
 let control2X2 = P4_4_x2 + 160;  // Adjust control points as needed
...
G.endShape();
G.pop();
let G5_x1 =O_schriftbild-2*O_vnb;
let G5_y1 = versalien_hilfslinie_2;
let G5_x2 = (O_schriftbild)+O_vnb;
...
let G_4_x2 =(O_schriftbild)+O_vnb;
let G_4_y2 = grundlinie_ueberhang-60;

// Define the control points for the bezier curve
 let controlGX1 = G_4_x1  - 190;  // Adjust control points as needed
//let control2X1 = P4_4_x1 + 140;  // Adjust control points as needed
let controlGY1 = G_4_y1 - 60;  // Example control point, adjust as needed
 let controlGX2 = G_4_x2 - 200;  // Adjust control points as needed
//let control2X2 = P4_4_x2 + 140;  // Adjust control points as needed
let controlGY2 = G_4_y2 + 230;  // Example control point, adjust as needed
...
///////////////////////////////////////////////////////////////////////////////////////
 noiseOffset += 0.05;   // 0.01,1, 0.0005, 5
//////////////////////////////////////////////////////////////////////////////////////////////
