...
var stepSize = 3; // Schrittgröße für die Bewegung der Buchstaben
...
function getPoints() {
  fontPath = font.getPath(typedKey, windowWidth/5, windowHeight/4, 1000
  ); // Erstellt einen Pfad für den eingegebenen Buchstaben
...
// Funktion, die bei Tastendruck aufgerufen wird
function keyPressed() {
    if (key == 's' || key == 'S') save("mySVG.png"); // Speichert das Bild als PNG-Datei bei Tastendruck 's' oder 'S'
}
