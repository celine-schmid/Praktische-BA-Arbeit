...
function setup() {
  ...
  let options = {
    ...
    outputs: 4, // Klassifizierung als Y, M, C oder A
    task: 'classification',
    debug: true
  }
  ...
  // Objekt erstellen
  const modelInfo = {
    model: 'assets/json/YMCA-Model/model.json',
    metadata: 'assets/json/YMCA-Model/model_meta.json',
    weights: 'assets/json/YMCA-Model/model.weights.bin',
  };
...
function draw() {
  ...
  text(poseLabel, windowWidth/2, windowHeight/2);
}
