...
function preload() {
  //bienen
  // module1 = loadImage('/assets/images/biene.png');
  // module2 = loadImage('/assets/images/biene.png');

//pusteblume
module1 = loadImage('/assets/images/pusteblume.png');
module2 = loadImage('/assets/images/pusteblume-2.png');


  //feder
  // module1 = loadImage('/assets/images/feder-3.png');
  // module2 = loadImage('/assets/images/feder-2.png');

  //blaetter
  // module2 = loadImage('/assets/images/5_V.png');
  // module1 = loadImage('/assets/images/8_H.png');
}
...
function draw() {
  ...
  if (textTyped.length > 0 && font != undefined) {
    ...
    var fontPath = font.getPath(textTyped, 0, 0, 500);
