...
//  noiseOffset += 50;  // Increment noise offset for animation effect
// //////////////////////////////////////////////////////////////////////////////////////////////
...
// // U
// let startX = H_vnb + (strichstaerke/2);
// let startY = H_linie + (O_versalhoehe * 0.66);
// let endX = H_vnb + E_schriftbild_7;
// let endY = H_linie + (O_versalhoehe * 0.66);
// let U_controlX1 = H_vnb + (E_schriftbild_7 / 4) - 38;
...
// U.strokeCap(SQUARE);
// U.stroke(0);
// for (let y = H_linie; y <= grundlinie; y += 5) {
//   let x = E_schriftbild_7 + H_vnb + map(noise(noiseOffset, y * 0.05), 0, 1, -10, 40);
//   U.vertex(x, y);
// }
// U.endShape();
// U.pop();
...
// U.strokeCap(SQUARE);
// U.stroke(0);
// for (let y = H_linie; y <= H_linie + (O_versalhoehe * 0.66); y += 5) {
//   let x = H_vnb + map(noise(noiseOffset, y * 0.05), 0, 1, -10, 40);
//   U.vertex(x, y);
// }
// U.endShape();
...
//   x += map(noise(noiseOffset, t * 5), 0, 1, -25, 40);
//   y += map(noise(noiseOffset + 1000, t * 0.05), 0, 1, -100, 40);
