...
let O_schriftbild = O_versalhoehe * 0.62; // Faktor unterscheidet sich je nach Schrift; hier an Helvetica orientiert
let O_vnb = O_schriftbild * 0.4; // Faktor muss je nach Schrift angepasst werden.
...
//   a.arc(m_5.x, m_5.y, 0.6 * schriftgrad , 0.6 * schriftgrad, -HALF_PI, 0);
  ...
  K = createGraphics(O_schriftbild + (4 * O_vnb), schriftgrad * 0.95);
  //K.background('white');
...
// Zurichtung
let O_vnb = O_schriftbild * 0.4; // Faktor muss je nach Schrift angepasst werden; Die Vor- und Nachbreite des O ist etwas kleiner als jenen des H.
...
let form_art = POINTS;
let schritt = 0.002; //0.02, 0.1, 0.003
let fuellfarbe = 0;
...
let H_4_y1 = H_linie + (strichstaerke/2);
...
H.endShape();
H.pop();
let H2_4_x1 =O_schriftbild + O_vnb - (strichstaerke/2) ;
let H2_4_y1 = H_linie + (strichstaerke/2);
let H2_4_x2 =  O_schriftbild + O_vnb - (strichstaerke/2);
...
let E_4_x1 = O_vnb + (strichstaerke/1.6) ;
let E_4_y1 = H_linie +(strichstaerke/2);
let E_4_x2 = O_vnb + (strichstaerke/1.6);
...
I.strokeCap(SQUARE);
I.vertex(O_vnb + (strichstaerke / 2), H_linie);
I.vertex(O_vnb + (strichstaerke / 2), grundlinie);
I.endShape();
// J
// J.push();
...
let K_4_x1 = O_vnb + (strichstaerke / 3) ;
let K_4_y1 = H_linie +(strichstaerke/2);
let K_4_x2 = O_vnb + (strichstaerke / 3);
...
K.endShape();
K.pop();
let K2_4_x1 = O_vnb + (O_schriftbild * 0.96)  ;
...
K.endShape();
K.pop();
let K3_4_x1 = O_vnb + (strichstaerke) + (O_schriftbild * 0.26) ;
...
L.vertex(O_vnb + (strichstaerke / 2), H_linie);
L.vertex(O_vnb + (strichstaerke / 2), grundlinie-(strichstaerke/2));
L.endShape();
L.beginShape(form_art);
L.strokeWeight(strichstaerke_waagerecht);
L.vertex(O_vnb , grundlinie - (strichstaerke/2));
L.vertex(O_vnb + O_schriftbild, grundlinie- (strichstaerke/2));
L.endShape();
// M
...
V.vertex(0, 0);
V.vertex(0, H_linie);
V.vertex(O_schriftbild + (2 * Versal_vbn_minimal), H_linie);
V.vertex(O_schriftbild + (2 * Versal_vbn_minimal), 0);
V.vertex(0, 0);
V.endShape();
V.beginShape(form_art);
V.vertex(0,grundlinie);
V.vertex(0, schriftgrad * 0.95);
V.vertex(O_schriftbild + (2 * Versal_vbn_minimal), schriftgrad * 0.95);
V.vertex(O_schriftbild + (2 * Versal_vbn_minimal), grundlinie);
V.endShape();
// W
W.push();
...
W.vertex(((Versal_vbn_minimal + (strichstaerke / 2)) + (((2 * O_vnb) + O_schriftbild) / 2)) / 2, grundlinie);
W.vertex((((2 * O_vnb) + O_schriftbild) / 2), H_linie);
W.vertex((((2 * O_vnb) + (O_schriftbild) - Versal_vbn_minimal - (strichstaerke / 2)) + (((2 * O_vnb) + O_schriftbild) / 2)) / 2, grundlinie);
W.vertex((2 * O_vnb) + (O_schriftbild) - Versal_vbn_minimal - (strichstaerke / 2) , H_linie);
W.endShape();
W.pop();
W.push();
W.fill(buchstaben_hintergrund);
W.noStroke();
W.rect(0, 0, O_schriftbild + ( 2 * O_vnb), H_linie);
W.pop();
// X
X.push();
...
Y.pop();
// Z O_schriftbild +(2 * O_vnb)
Z.push();
Z.beginShape(form_art);
Z.strokeWeight(strichstaerke);
Z.strokeCap(SQUARE);
Z.strokeJoin(ROUND);
Z.vertex(O_vnb, H_linie + (strichstaerke / 2));
Z.vertex(O_vnb + O_schriftbild, H_linie + (strichstaerke / 2));
Z.vertex(O_vnb, grundlinie - (strichstaerke / 2));
Z.vertex(O_vnb + O_schriftbild,grundlinie - (strichstaerke / 2));
Z.endShape();
Z.pop();
Z.push();
Z.fill(buchstaben_hintergrund);
Z.noStroke();
Z.rect(0, 0, O_vnb, schriftgrad * 0.95);
Z.rect(O_vnb + O_schriftbild, 0, O_vnb, schriftgrad * 0.95);
Z.pop();
...
// }
// H.endShape();
 noiseOffset += 5;  // Increment noise offset for animation effect    // 0.01,1, 0.0005
//////////////////////////////////////////////////////////////////////////////////////////////
